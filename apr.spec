...
# Drop pkgconfig provide
%{?filter_setup:
%filter_provides_in %{_libdir}/pkgconfig/
%filter_setup
}
...
Patch100: apr-1.4.8-httpd24-soname.patch
...
%changelog
* Mon Feb 02 2015 Jan Kaluza <jkaluza@redhat.com> - 1.5.1-1
- update to version 1.5.1 (#1187646)

* Wed Jan 28 2015 Jan Kaluza <jkaluza@redhat.com> - 1.4.8-4
- rebuild for rhscl-2.0

* Thu Jan 09 2014 Jan Kaluza <jkaluza@redhat.com> - 1.4.8-3
- drop pkgconfig provide (#1042877)

* Tue Sep 17 2013 Jan Kaluza <jkaluza@redhat.com> - 1.4.8-2
